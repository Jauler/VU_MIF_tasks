...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.75\textwidth]{img/MultidimensionalGallery.png}
...
Biometriniai įrašai saugomi tik viename iš ankščiau minėtų biometrinių įrašų blokų, todėl šiuos blokus patogu analizuoti kaip daugiamatės erdvės particijas.
...
Taip pat, viena particija gali susidėti iš daugiau nei vienoos, nebūtinai jungios dalies.
